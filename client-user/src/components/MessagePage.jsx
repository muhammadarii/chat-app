    ...
    >
      <header className="sticky top-0 h-16 bg-white flex justify-between items-center px-4">
        <div className="flex items-center gap-4">
          <Link
            to={"/"}
            className="lg:hidden cursor-pointer text-slate-500 hover:text-primary"
          >
            <FaAngleLeft size={20} />
          </Link>
          <div>
          ...
          <div className="w-full h-full bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden">
            ...
            <div className="bg-white p-3 rounded-2xl">
              <img
                ...
                alt="uploadImage"
                className="aspect-square w-full h-full mas-w-sm m-2 object-scale-down"
              />
            </div>
          </div>
        )}
          ...
          <div className="w-full h-full bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden">
            ...
            <div className="bg-white p-3 rounded-2xl">
              <video
                ...
                className="aspect-video w-full h-full mas-w-sm m-2 object-scale-down"
                controls
                muted
                autoPlay
              />
